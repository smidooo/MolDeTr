...
def test_simulate_checkpoint_absent(app_module, monkeypatch):
    ...
    _t, _f, msg = app_module.simulate_and_detect(grid, widths, False, 3.0, 0.0, 0.0, 0.0, 0.3)
...
def test_simulate_ethyl_roundtrip(patch_model):
    ...
    table, fig, msg = app.simulate_and_detect(grid, widths, False, 3.0, 0.0, 0.0, 0.0, 0.3)
...
def test_simulate_singlet_gt_j_dashed(patch_model):
    ...
    table, _f, msg = app.simulate_and_detect(grid, widths, False, 3.0, 0.0, 0.0, 0.0, 0.3)
