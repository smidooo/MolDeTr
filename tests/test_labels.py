...
def test_synthetic_couplings_points_to_hz():
    m = from_synthetic(
        {
            "proton_number": 3,
            "center_position_in_points": 1000.0,
            "line_width_in_points": 3.6,
            "bounding_box_range_in_points": 37.5,
...
def test_experimental_couplings_stay_hz():
    m = from_experimental(
        {
            "proton_count": 3,
            "chemical_shift_in_points": 3983.0,
            "coupling_constants": [7.13],
            "chemical_shift_ppm": -3.3,
        }
    )
...
def test_both_produce_identical_canonical_schema():
    syn = from_synthetic(
        {
            "proton_number": 2,
            "center_position_in_points": 500.0,
            "coupling_constants_in_points": [36.0],
        }
    )
    exp = from_experimental(
        {"proton_count": 2, "chemical_shift_in_points": 500.0, "coupling_constants": [36.0 / 5.12]}
    )
